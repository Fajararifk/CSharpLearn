...
namespace Day5
{
    internal abstract class Person
    {
        ...
        {
            return $"Social Number : {this.socialNumber} | FullName : {this.firstName} {this.lastName} | Email : {this.email} | BirthDate : {this.birthDay} | Total Revenue : {this.totalRevenue.ToString("C", new CultureInfo("id-ID"))}";
        }
